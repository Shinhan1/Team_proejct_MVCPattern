<%@page import="com.exam.safety.dao.Join2_DAO"%>
...
<script type="text/javascript">
	...
	var email = document.getElementById("email1").value;
		...
		url = ("mailsend.jsp?mail=" + document.getElementById("email1").value+"@"+document.getElementById("email_select").value);
		open(
				url,
				"confirm",
...
<div id="top">
	...
	<form method="post" action="join2Ok.jsp" onsubmit="return check()" accept-charset="utf-8"
			class="form-box" >
			...
			<table class="table input_table">
				...
				<tr>
					<th><span>단체명</span></th>
					<td><input name="groupName" type="text" class="basic"
						id="groupName"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="groupNumber" type="text" id="userNum"
						class="groupNum" placeholder="13자리로 입력해주세요 ('-'제외)"
						onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
						maxlength="13" > <input type="button"
						id="btnCheck" value="번호 찾기" onclick="openWin()" class="groupBtn"
						 /></td>
				</tr>
				...
				<tr>
					...
					<td><input name="userId" id="userId" type="text"
						...
						value="중복 체크" onclick="confirmId()" name="confirm_id"
						class="groupBtn" /> <input type="hidden" name="idDuplication"
						value="idUncheck"  />
				...
				<tr>
					...
					<td><input name="email1" type="text" class="emailBox1"
						maxlength="30" id="email1" > 
						@
						<input name="email2"
						type="text" class="emailBox2" value="">
							<select name="email_select" title="이메일주소 선택" class="email3" id="email_select">
						...
						</select> <input type="button" id="submit" value="이메일 인증" onclick="emailCheck()"
								name="passWordOk" class="groupBtn" /> 
							</div>
					</td>
				</tr>
