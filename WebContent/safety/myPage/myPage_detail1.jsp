...
/*
		...
		#writer, #title, #email, #inquiry{margin-left:10px;} */
								...
								<%
								  String ke = (String)session.getAttribute("member"); /* 로그인 색션 가져오기 */
									Join1_DAO dao = new Join1_DAO();
									 Join1_VO vo = dao.getAllData(ke);
								%>
<script
...
<%-- 	var domain = '<%= domain %>'; --%>
	...
	function modifyData(obj){
		...
		if(flag) {
			$("#no").val(email);
			document.frm.action = "modify1.jsp";
			document.frm.submit();
						...
						<form action="#" name="frm">
							...
							<table class="inquiry_Table">
								...
								<tr class="onetr">
									...
									<td><input type="button" value="비밀번호 변경하기" id="passwordCh" /></td>

								</tr>
								<tr class="onetr">
									<th><span>휴대폰 번호</span></th>
									<td><span><%=vo.getPhone() %></span></td>
